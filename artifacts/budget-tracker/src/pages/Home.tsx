            ...
            >
              ...
              <Card className="text-center py-8 relative overflow-hidden bg-gradient-to-b from-[#7c3aed] to-[#4c1d95] text-white shadow-xl shadow-purple-900/40">
                ...
                >
                  <p className="text-primary-foreground/80 text-xs sm:text-sm font-medium uppercase tracking-wider mb-2">
                    Сегодня доступно a = I + k
                  </p>
                  <div className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight mb-2 tabular-nums flex items-end justify-center gap-2">
                  ...
                  <p className="text-xs text-muted">
                    I = {formatCurrency(dailyLimit)}
                  </p>
                  <p className="text-xs text-muted">
                    k = {formatCurrency(savings)} (на {lastUpdateDate})
                  </p>
                  <p className="text-xs text-muted">
                    Остаток R = {formatCurrency(remainingBudget)}, дней D = {remainingDays}
                  </p>
                </motion.div>
              </Card>
              ...
              <Card className="space-y-3 relative">
                ...
                <motion.button
                  onClick={startPeriod}
                  whileTap={{ scale: 0.96 }}
                  className="w-full py-3 rounded-xl font-bold text-sm bg-indigo-600 text-white"
                >
                  Запустить период (R = доход, D = дней)
                </motion.button>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.96 }}
                  className="w-full py-3 rounded-xl font-bold text-sm bg-green-500 text-white"
                >
                  Принять расход
                </motion.button>
